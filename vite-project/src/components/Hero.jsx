...
export default function Hero() {
  ...
  return (
    <section className="relative   min-h-screen flex items-center justify-center overflow-hidden ">
      ...
      <div className="max-w-7-xl mx-auto text-center relative w-full  ">
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative     ">
          <div className="">
            <div className="inline-flex items-center space-x-2 px-3 sm:px-4 py-2 bg-blue-500/10  border border-blue-500/20 rounded-full mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700       ">
              ...
              <span className="text-x5 sm:text-sm text-blue-300 ">
...
It is widely used in fields like healthcare, transportation, and software development to improve efficiency and solve complex problems.
          ...
          <div className="relative order-2 w-full">
            <div className=" relative  p-3 sm:p-4 bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-2xl border border-white/10  ">
